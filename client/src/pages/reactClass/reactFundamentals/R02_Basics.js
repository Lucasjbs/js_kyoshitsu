...
import React02_Code01 from '../../../assets/react02_Code01.png'
import React02_Code02 from '../../../assets/react02_Code02.png'
import React02_Code03 from '../../../assets/react02_Code03.png'
import React02_Code04 from '../../../assets/react02_Code04.png'
...
function R02_Basics() {
  ...
  return (
    <>
        ...
        <img src={React02_Code01} alt='Basic Component'></img>
        <br></br>
        <br></br>
        ...
        <p><Link to={{ pathname: "/react/examples/1"}} target="_blank" rel="noreferrer">Example:</Link></p>
        <img src={React02_Code02} alt='JSX Conversion'></img>
        <br></br>
        <br></br>
        ...
        <img src={React02_Code03} alt='Father Element'></img>
        ...
        <img src={React02_Code04} alt='JSX Styles'></img>
        <br></br>
        <br></br>
    </>
  )
